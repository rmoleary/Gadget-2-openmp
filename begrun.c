...
void begrun(void)
{
  ...
  if(RestartFlag == 2)
...
#ifdef SHORTSTEP
    All.oMaxSizeTimestep = All.MaxSizeTimestep;
#endif
    ...
    int k;
    double xchange = 4000;
    double ychange = sqrt(2.*((sqrt(All.rp_ryan*All.rp_ryan*(All.rp_ryan*All.rp_ryan+4.*xchange*xchange)))+All.rp_ryan*All.rp_ryan));
